...
abstract class $HomeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({HomeStatus status, List<Breed> breeds});
}
...
class _$HomeStateImpl implements _HomeState {
  const _$HomeStateImpl(
      {this.status = HomeStatus.initial, final List<Breed> breeds = const []})
      : _breeds = breeds;
  ...
  @override
  String toString() {
    return 'HomeState(status: $status, breeds: $breeds)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, status, const DeepCollectionEquality().hash(_breeds));
...
abstract class _HomeState implements HomeState {
  const factory _HomeState(
      {final HomeStatus status, final List<Breed> breeds}) = _$HomeStateImpl;
